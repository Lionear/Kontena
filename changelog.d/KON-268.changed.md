- **Nightly and preview versions lost the date, and gained a build date you can actually see.**
  ...
  `0.3.0-nightly.44`, and the day the build was made is shown next to the version in About and in
  Settings › Updates instead. A build you made yourself has no such date and no longer pretends to.
