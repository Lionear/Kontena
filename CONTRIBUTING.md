...
cannot follow. Each build publishes into a channel named `<platform>-<stream>`
(`linux-stable`, `win-nightly`, …). The platform is part of the name because a channel is one feed,
