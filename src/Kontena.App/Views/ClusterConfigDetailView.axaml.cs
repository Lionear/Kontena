...
public partial class ClusterConfigDetailView : UserControl
{
    public ClusterConfigDetailView() => InitializeComponent();

    /// <summary>
    /// Copy a value without putting it on screen (KON-249, moved here with the keys in KON-330).
    /// <para>
