...
/// <para>
/// Only ever what actually goes. A line here is a promise that the thing is deleted, and a dialog
/// that over-promises is worse than one that says nothing — the next time it is believed less.
/// </para>
/// </remarks>
